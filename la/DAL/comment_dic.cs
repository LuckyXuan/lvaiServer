...
namespace la.DAL
{
	...
	public partial class comment_dic
	{
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("评价字典编号", "comment_dic"); 
		}
		...
		public bool Exists(int 评价字典编号)
		{
			...
			strSql.Append("select count(1) from comment_dic");
		...
		public bool Delete(int 评价字典编号)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from comment_dic ");
			strSql.Append(" where 评价字典编号=@评价字典编号 ");
			SqlParameter[] parameters = {
					new SqlParameter("@评价字典编号", SqlDbType.Int,4)			};
			parameters[0].Value = 评价字典编号;
		...
		public bool DeleteList(string 评价字典编号list )
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from comment_dic ");
			strSql.Append(" where 评价字典编号 in ("+评价字典编号list + ")  ");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select 评价字典编号,评价字典内容,对应分值 ");
			strSql.Append(" FROM comment_dic ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from comment_dic T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "comment_dic";
