...
namespace la.DAL
{
	...
	public partial class carInfo
	{
		...
		public bool Add(la.Model.carInfo model)
		{
			...
			parameters[2].Value = model.car_level;
			parameters[3].Value = model.car_brand;
			parameters[4].Value = model.car_type;
			parameters[5].Value = model.car_photo1;
			parameters[6].Value = model.car_photo2;
			parameters[7].Value = model.car_photo3;
			parameters[8].Value = model.car_photo1_state;
			parameters[9].Value = model.car_photo2_state;
			parameters[10].Value = model.car_photo3_state;
